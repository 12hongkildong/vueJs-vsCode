      ...
      <section>
         ...
         <section v-if="menu">
            <div class="menu-detail">
               <header>
                  ...
                  <div class="img-div">
                     ...
                     <img alt="" :src="'/image/product/'+menu.img">
                  </div>
               </header>
               <article>
                  <header>
                     <h1 class="text-title2"  >{{ menu.name }}</h1>
                     <span class="text-normal" >{{menu.price}}</span>
                  </header>
                  <p class="text-normal">{{menu.description}}
                  </p>
               </article>
            ...
            <section class="menu-rcmd">
               ...
               <div>
                  <a href="">
                     <img class="image-view-round" src="https://images.unsplash.com/photo-1515442261605-65987783cb6a?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80" alt="">
                     <span>아몬드 쿠키</span>
                  </a>
               </div>
            </section>
